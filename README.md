...
# Keeloke TV Server — Ultra-Low Latency, HLS, SRT, RTMP, WebRTC Streaming Engine
...
Keeloke TV Server is a **scalable, open-source media server** designed for **ultra-low latency live streaming** with **WebRTC (~0.5s)**, plus support for **SRT, RTMP, RTSP, HLS, and CMAF Low-Latency HLS (LL-HLS)**.  
It enables developers to build **real-time video applications, live broadcasting, and adaptive bitrate (ABR) workflows**.

Use Keeloke TV Server to power **telehealth platforms, e-learning, sports streaming, auctions, enterprise video solutions, and interactive applications.**

### Why Choose Keeloke TV Server?
