...
@OpenAPIDefinition(
		info = @Info(
				description = "Keeloke TV Server - Player Analytic Events Endpoint. It just logs the incoming player events",
				version = "v2.0",
				title = "Keeloke TV Server - Player Analytic Events Endpoint",
